...
class StoryElements:
    ...
    def day_one(self):
        ...
        your pack, you find your sword, put out the fire, and head out of the cave you hunkered down in for the night. 
        "FRESH AIR!" You set out through the woods to continue searching for the goblin hoard that has been attacking a
        local village. They have requested your services, and you will see it to completion. You hear a sound coming 
        from the right and suddenly a goblin jumps out of the bushes What will you do? Attack or attempt to flee?
        ''')
